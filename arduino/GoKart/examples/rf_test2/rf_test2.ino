...
void loop()
{
  ...
  Serial.print(" | "); Serial.print(cmd.stwheel.data);
  
  Serial.print(" Ch2: "); Serial.print(rf.getChannel(1));
  Serial.print(" | "); Serial.print(cmd.brake.data);
  Serial.print(" | "); Serial.print(cmd.throttle.data);
  
  Serial.print(" Ch3: "); Serial.print(rf.getChannel(2));
  Serial.print(" | "); Serial.print(cmd.emergency.data);

  Serial.print(" Stamp: "); Serial.println(cmd.stamp.data);
